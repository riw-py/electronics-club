...
function handleFileSelected(file) {
  ...
  nameEl.textContent = `<i class="fa-solid fa-paperclip"></i> ${file.name} (${formatFileSize(file.size)})`;
  nameEl.style.display = 'block';
  document.getElementById('upload-icon').textContent = '<i class="fa-solid fa-check"></i>';
...
async function doUpload() {
  ...
  try {
    ...
    labelEl.textContent = 'อัปโหลดสำเร็จ! <i class="fa-solid fa-check"></i>';
    ...
    btn.disabled = false; btn.textContent = '<i class="fa-solid fa-file-arrow-up"></i> อัปโหลด';
  }
}
...
function resetUploadForm() {
  ...
  document.getElementById('upload-icon').textContent = '<i class="fa-solid fa-file-arrow-up"></i>';
